...
def generate_launch_description():
    ...
    angle_calib_dir_path = os.path.join(pkg_share, 'conf/angle/')
    calib_file_path = os.path.join(pkg_share, 'conf/calibration.yaml')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            output='screen', 
            parameters=[{
                'device_interface': "gmsl", # "usb"/"gmsl"
                'image_input_fps': 10,
                'imu_input_fps': 200,
                'enable_jpeg': False,
