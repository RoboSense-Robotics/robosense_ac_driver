...
// rsacdevicefactor
using ROS_PUBLISHER_RSACDEVICEFACTOR = ros::Publisher;
using ROS_PUBLISHER_RSACDEVICEFACTOR_PTR =
    std::shared_ptr<ROS_PUBLISHER_RSACDEVICEFACTOR>;
#elif defined(ROS2_FOUND)
// Publisher(s)
// image
...
using ROS_PUBLISHER_RSACDEVICECALIB_PTR =
    std::shared_ptr<ROS_PUBLISHER_RSACDEVICECALIB>;
// rsacdevicefactor
using ROS_PUBLISHER_RSACDEVICEFACTOR = rclcpp::Publisher<ROS_RSACDEVICEFACTOR>;
using ROS_PUBLISHER_RSACDEVICEFACTOR_PTR =
    std::shared_ptr<ROS_PUBLISHER_RSACDEVICEFACTOR>;
// 零拷贝消息 Publisher(s)
// RsImage1M
